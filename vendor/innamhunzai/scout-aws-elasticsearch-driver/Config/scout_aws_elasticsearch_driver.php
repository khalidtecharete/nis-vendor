...
/**
 * Modified config from cviebrock/laravel-elasticsearch
 * @see https://github.com/cviebrock/laravel-elasticsearch/blob/master/config/elasticsearch.php
 */
        ...
        'default' => [
            ...
            'hosts' => [
                [
                    ...
                    'scheme'     => env('SCOUT_ELASTIC_SCHEME', null),
                    'user'       => env('SCOUT_ELASTIC_USER', null),
                    'pass'       => env('SCOUT_ELASTIC_PASS', null),
                    'aws'        => env('SCOUT_AWS_ELASTIC_ENABLED', false),
                    'aws_region' => env('SCOUT_AWS_ELASTIC_REGION', ''),
                    'aws_key'    => env('SCOUT_AWS_ELASTIC_ACCESS_KEY', ''),
                    'aws_secret' => env('SCOUT_AWS_ELASTIC_ACCESS_SECRET', '')
                ],
            ],
            /**
             * SSL
